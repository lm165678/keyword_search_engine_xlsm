...
public class TFIDFCalculator {
  ...
  public double tf(int doc, int term) {
    /*
     * IMPORTANT: each skill suppose to only appear once in each document in this case term
     * frequency is not considered, assuming all individual skills in each individuals skills sets
