...
public class TFIDFCalculator {
	...
	/*
	 * IMPORTANT: each skill suppose to only appear once in each document in this
	 * case term frequency is not considered, assuming all individual skills in each
	 * individuals skills sets are equally important
	 */
	return 1 / doc;
    }
